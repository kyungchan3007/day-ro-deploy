...
public class RegionDataLoader implements CommandLineRunner {
    ...
    private record CuratedRegion(String category, String displayName, String dong) {
    }
    ...
    private Map<String, CuratedRegion> loadCuratedRegions() {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
            ...
            while ((line = reader.readLine()) != null) {
                ...
                curatedRegions.put(columns[0], new CuratedRegion(columns[1], columns[2], columns[3]));
            }
        } catch (IOException e) {
