...
public class RegionController {
    ...
    public ResponseEntity<ApiResponse<List<RegionResponse.RegionItem>>> getPopularKeywords() {
        return ResponseEntity.ok(ApiResponse.success(regionService.getPopularKeywords()));
    }
}
