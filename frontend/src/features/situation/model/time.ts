...
/** 데이트 길이 정책: 최소 2시간 ~ 최대 12시간. */
export const MIN_SITUATION_DURATION_MINUTES = 2 * 60;
export const MAX_SITUATION_DURATION_MINUTES = 12 * 60;
...
/** 최소 데이트 길이(2시간) 미만인지. */
export function belowMinDuration(range: TimeRange): boolean {
  return durationMinutes(range) < MIN_SITUATION_DURATION_MINUTES;
}
