...
import styles from "./css/TransportCardGroup.module.css";
      ...
      {choices.map((choice) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative flex flex-col items-center gap-2 rounded-2xl border transition-colors",
              styles.optionButton,
              active
          ...
          >
            <span
              ...
              aria-hidden="true"
              style={{ "--transport-accent": meta.colorVar } as CSSProperties}
            >
              <Icon size={22} />
            </span>
            <span
