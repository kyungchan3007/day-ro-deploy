...
import styles from "./css/PurposeOptionGrid.module.css";
      ...
      {choices.map((choice) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative flex flex-col items-center gap-2.5 rounded-2xl border transition-colors",
              styles.optionButton,
              active
          ...
          >
            <span
              ...
              aria-hidden="true"
              style={{ "--purpose-accent": meta.colorVar } as CSSProperties}
            >
              <Icon size={24} />
            </span>
            <span
